  ...
  return (
    <section className="min-h-[70vh] flex items-center justify-center px-6 py-32">
      <div className="max-w-lg text-center flex flex-col items-center gap-6">
        <CheckCircle size={56} className="text-[#B3B727]" strokeWidth={1.5} />
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-4">
          <Link
            href="/"
            className="px-8 py-3.5 bg-[#B3B727] text-black text-xs tracking-[0.2em] uppercase font-medium hover:bg-[#c6c95d] transition-colors duration-200"
          >
            Back to Home
          </Link>
          <a
            href={`tel:${COMPANY.phoneHref}`}
            className="inline-flex items-center justify-center gap-2 px-8 py-3.5 border border-border text-foreground text-xs tracking-[0.2em] uppercase hover:border-[#B3B727] hover:text-[#B3B727] transition-all duration-200"
          >
            <Phone size={13} />
            {COMPANY.phone}
          </a>
